...
return logits shaped ``(batch, alphabet)``.
"""
...
def _optional_import(package_name, import_name=None):
    try:
        ...
        raise ImportError(
            ...
            "Install the rote-bench[experiment] extra to run this architecture."
        ) from exc
...
TRANSFORMER_STYLE_MODELS = {"Transformer", "LinearAttention", "Performer", "RWKV"}
